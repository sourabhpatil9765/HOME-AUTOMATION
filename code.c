...
const char* ssid = "5friends"; // SSID i.e. Service Set Identifier is the name of your WIFI
const char* password = "fuckyou1234"; // Your Wifi password, in case you have open network comment the whole statement.
